...
class Track:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.update(frame_id, bbox, detection_confidence, class_id=class_id, display=self.display, lost=lost, iou_score=iou_score, **kwargs)
    ...
    def update(self, frame_id, bbox, detection_confidence, display, class_id=None, lost=0, iou_score=0., **kwargs):
        """
        Update the track.
